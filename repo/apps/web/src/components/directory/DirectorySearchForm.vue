...
import type { DirectorySearchFilters } from '@/types'

const emit = defineEmits<{
  search: [filters: DirectorySearchFilters]
}>()
...
function onSubmit() {
  emit('search', {
    ...
    repertoire: repertoire.value || undefined,
...
<template>
  <form class="directory-search" @submit.prevent="onSubmit">
    <div class="directory-search__grid">
      <label>
        <span>Keyword</span>
        <input v-model="keyword" placeholder="Name, stage alias, bio…" />
      </label>

      <label>
        <span>Actor / Person</span>
        <input v-model="actor" placeholder="Ava, Ben…" />
      </label>

      <label>
        <span>Repertoire</span>
        <input v-model="repertoire" placeholder="Moonlight, Overture…" />
      </label>

      <label>
        <span>Tags (comma-separated)</span>
        <input v-model="tagsCsv" placeholder="jazz, drama" />
      </label>
    ...
    <div class="directory-search__actions">
